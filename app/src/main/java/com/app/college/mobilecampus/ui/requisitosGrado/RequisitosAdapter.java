...
public class RequisitosAdapter extends BaseExpandableListAdapter {
    ...
    public RequisitosAdapter (Context context, List<String> listGroup, HashMap<String, List<String>> listItem){
    ...
    public View getGroupView(int i, boolean b, View view, ViewGroup viewGroup) {
        ...
        if (view == null){
            ...
            view = layoutInflater.inflate(R.layout.requisitos_list_group, null);
        }
    ...
    public View getChildView(int i, int i1, boolean b, View view, ViewGroup viewGroup) {
        ...
        if (view == null){
            LayoutInflater layoutInflater = (LayoutInflater) this.context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            view = layoutInflater.inflate(R.layout.requisitos_list_item, null);
        }
